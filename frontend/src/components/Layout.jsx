    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-[220px] flex-shrink-0 bg-bg-2 border-r border-white/5 flex flex-col">
        <div className="p-5 border-b border-white/5">
          <h1 className="text-xl font-extrabold font-syne gradient-text">
            Goal Tracker
          </h1>
        </div>

        <nav className="p-3 flex-1">
          <p className="text-[10px] font-bold text-text-3 uppercase tracking-widest px-2 py-2 font-syne">
            Main
          </p>
          ...
          {NAV.map(({ to, label, icon }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `sidebar-link ${isActive ? 'active' : ''} mb-0.5`
              }
            >
              {icon} {label}
            </NavLink>
          ...
          <p className="text-[10px] font-bold text-text-3 uppercase tracking-widest px-2 py-2 mt-3 font-syne">
            Insights
          </p>
        ...
        <div className="p-3 border-t border-white/5">
          <div className="flex items-center gap-2.5 p-2.5 bg-bg-3 rounded-lg">
            ...
            <button
              ...
              className="text-text-3 hover:text-brand-red transition-colors"
              title="Logout"
            >
              <LogoutIcon />
            </button>
      ...
      {/* Main Layout */}
      <main className="flex-1 flex flex-col bg-bg-1 h-screen overflow-hidden">
        ...
        © 2026 Aditya Yadav | Goal Tracker
        </footer>
